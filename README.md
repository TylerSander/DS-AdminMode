...
An **admin / cheat menu** for [Data Center](https://store.steampowered.com/app/4170200/Data_Center/) — free store purchases, free XP shop unlocks, unlimited reputation, and add-any-amount buttons for money, XP, and reputation.
